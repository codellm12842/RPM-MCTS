...
sys_prompt = '''You will play the role of a code implementer, writing a complete code based on the given problem.
Rules:
- Importing function libraries(like: import math) and output function code only, without main function and any explanation at the outset so that I can call your generated functions directly.
